...
class blog extends Model
{
	...
	protected $fillable = [
    	'tittle', 'des', 'image', 'content',
    ];

    // public function subComments() {
    // 	return $this->hasMany('App\Models\comment','id_comment')->with('subComments');
    // }
...
nghĩa là 1 json có 1 relationship là n json, từng n json lại có thêm 1 relationship nữa là m json khác.... */
    public function comments() {
        return $this->hasMany('App\Models\comment', 'blog_id')->where('id_comment', 0)->with('subComments');
    }

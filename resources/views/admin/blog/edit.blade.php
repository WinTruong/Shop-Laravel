                    ...
                    <div class="card-body">
                        ...
                        <form action="" class="form-horizontal form-material" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="tittle" class="form-control form-control-line" value="{{ $editblog['tittle'] }}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea name="des" rows="5" class="form-control form-control-line">{{ $editblog['des'] }}</textarea>
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <label><b>Content</b></label>
                                <textarea name="content" class="form-control" id="content">{{ $editblog['content'] }}</textarea>
                            </div>
